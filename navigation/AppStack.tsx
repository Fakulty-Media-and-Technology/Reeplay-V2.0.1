...
import { IVoteInfo } from '@/types/api/content.types';
...
export type MenuNavigatorParams = NativeStackNavigationProp<DrawerNavigatorProps>
...
const AppStack = () => {
  return (
    <Drawer.Navigator
      ...
      <Drawer.Screen name={routes.TRANSACTION_HISTORY_SCREEN} component={TransactionHistory} />
      <Drawer.Screen
