...
import ProfilePicUpdate from '@/Screens/authentication/ProfilePicUpdate';
...
export type AuthStackParamList = {
  ...
  [routes.PROFILE_PIC_UPDATE]: undefined;
...
const AuthNavigation = () => {
  return (
    <Auth.Navigator
      ...
      <Auth.Screen name={routes.PROFILE_PIC_UPDATE} component={ProfilePicUpdate} />
