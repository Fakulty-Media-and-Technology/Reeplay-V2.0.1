  ...
  return (
    <AppScreen containerStyle={{paddingTop: 15}}>
      ...
      <AppView className="items-center mt-24">
        <AppImage
          source={{uri: selectedContestant?.photo_url, priority:FastImage.priority.high}}
          style={{
            width:160,
            height:160,
            borderRadius:22,
        ...
        <AppView className="flex-row items-center justify-center mt-10 mb-4">
          <TouchableOpacity
            onPress={() =>
          ...
          <TouchableOpacity
            ...
            style={{
              backgroundColor:
                // voteCount >= 5 ? '#626161CF' : colors.RED,
                colors.RED
            }}
