    ...
    <AppView className="mt-5">
      ...
      <SelectTabs
        tabs={[
          ...
          {
            tab: 'Channels',
            element: <ChannelsTabs item={channels} scrollY={scrollY} />,
          },
          {
            tab: 'Events',
            element: <EventsTab item={events} scrollY={scrollY} />,
          },
          {
            tab: 'TV Shows',
            element: <TvShowsTab item={tvshows} scrollY={scrollY} />,
          },
          {
            tab: 'Sports',
            element: <SportsTab item={sports} scrollY={scrollY} />,
          },
          {
            tab: 'Podcast',
            element: <PodcastTab item={podcasts} scrollY={scrollY} />,
          },
        ]}
